# Generated by Django 5.0 on 2024-02-12 22:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(db_index=True, verbose_name='created at')),
                ('updated_at', models.DateField(db_index=True, verbose_name='updated at')),
                ('is_done', models.BooleanField(db_index=True, default=False, verbose_name='is done')),
                ('dead_line', models.DateTimeField(blank=True, db_index=True, null=True, verbose_name='deadline')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to=settings.AUTH_USER_MODEL, verbose_name='project')),
